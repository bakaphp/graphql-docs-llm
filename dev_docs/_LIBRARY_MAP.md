...
Definición completa del esquema GraphQL. Estructura optimizada para Agentes de IA.

## 🚀 [Puntos de Entrada (Queries/Mutations)](./_INDEX_ROOT.md)
Define acciones disponibles: **Queries** para lectura y **Mutations** para escritura.
